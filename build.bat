...
rgblink -p 0xFF -m bin\packettest.map -n bin\packettest.sym -o bin\packettest.gb obj\main.o obj\length.o obj\delayplotter.o obj\ramplotter.o obj\init.o obj\sub.o
:: fix the header
